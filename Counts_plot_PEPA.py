...
df2 = pd.DataFrame(np.array([[1, 2988], [2,3373], [3, 3298], [4, 3563], [5, 4128], [6, 3621], [7, 4763]]),
                   columns=['med1','med2']) ## kuvion luokkien ryhmittelyt aiemman koodin mediaanien mukaan, toimii tässäkin

df_counts2 = df2.groupby(['med1', 'med2']).size().reset_index(name='counts')        
#visu = ['#519b2f', '#94be7b', '#b8ceae', '#dcdfe2', '#d2aabd','#c97498', '#be3f72'] ## thl-värit muistissa
